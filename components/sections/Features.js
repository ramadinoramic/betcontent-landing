...
export default function Features() {
  return (
    <ScrollSection id="features" className="relative z-[1] max-w-[1100px] mx-auto px-7 py-[72px]">
      ...
      <div className="grid grid-cols-3 gap-3">
        {features.map((f, i) => {
          ...
          return (
            <div
              key={i}
              className="feature-card p-[26px_22px] rounded-2xl bg-white/[0.012] border border-white/[0.04] relative overflow-hidden"
            >
              <div
              ...
              />
              <div
                className="mb-4 w-12 h-12 rounded-[14px] flex items-center justify-center"
                style={{
              ...
              <h3 className="font-display text-[15px] font-bold text-gray-50 mb-[7px]">{f.title}</h3>
