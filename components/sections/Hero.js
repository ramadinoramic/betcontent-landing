...
export default function Hero() {
  return (
    <section id="waitlist" className="relative z-[1] max-w-[1100px] mx-auto px-7 pt-[152px] pb-16 text-center">
      {/* Badge */}
      <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-400/[0.05] border border-brand-400/10 mb-7">
        ...
        <span className="text-[12px] font-semibold text-brand-400 tracking-wide">
          AI-Powered · Early Access Spring 2026
        </span>
      </div>

      {/* Headline */}
      <h1 className="animate-fade-up animation-delay-100 font-display text-[clamp(38px,5.2vw,68px)] font-extrabold leading-[1.06] text-gray-50 tracking-[-0.035em] max-w-[780px] mx-auto mb-6">
        Match previews that
        <br />
      ...
      {/* Subheadline */}
      <p className="animate-fade-up animation-delay-200 text-[clamp(15px,1.7vw,18px)] text-gray-500 leading-[1.7] max-w-[520px] mx-auto mb-9">
      ...
      {/* Email CTA */}
      <div className="animate-fade-up animation-delay-300 mb-5">
        <WaitlistForm />
      </div>
      ...
      {/* App preview mock */}
      <div className="animate-fade-up animation-delay-500 mt-16 relative">
        <div className="rounded-[18px] overflow-hidden p-[3px] bg-white/[0.02] border border-white/[0.05] shadow-[0_32px_100px_rgba(0,0,0,0.4),0_0_50px_rgba(52,211,153,0.04)]">
          <div className="rounded-[16px] bg-surface-raised p-[18px_22px]">
            {/* Browser chrome */}
            <div className="flex items-center gap-2 mb-[18px]">
              ...
              <div className="flex-1 h-[26px] rounded-[7px] bg-white/[0.035] flex items-center pl-3">
